...
x = [np.log10(10), np.log10(100), np.log10(1000), np.log10(10000)]
ytrain = [-7.827, -6.539, -5.469, -4.861]
ytest = [-7.625, -6.117, -5.002, -4.423]
plt.plot(x, ytrain, label='train')
plt.plot(x, ytest, label='test')
plt.xlabel("sequence (log scale)")
